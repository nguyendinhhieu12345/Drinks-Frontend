...
function CreateBranch() {
    ...
    const getBranchDetail = async () => {
        try {
            ...
            if (data?.success) {
                ...
                // console.log(province.filter(prov => prov.province_name === data?.data?.province)[0])
                // getAllDistrict(province.filter(prov => prov.province_name === data?.data?.province)[0]?.province_id)
            }
        } catch {
    ...
    return (
        <div className="flex flex-col w-full h-auto overflow-y-auto justify-between">
            ...
            <div className="bg-white rounded-lg mt-4 flex flex-col w-full h-auto justify-between overflow-y-auto">
                <div className="flex-grow scrollbar-hide w-full max-h-full p-4">
                    {/* Input Province */}
                    <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                        ...
                        <div className="col-span-8 sm:col-span-4">
                            <select
                                ...
                                value={newBranch?.province !== "" ? [province.filter(prov => prov?.province_name === newBranch?.province)[0]?.province_id, province.filter(prov => prov?.province_name === newBranch?.province)[0]?.province_name] : ""}
                            >
                                {newBranch?.province !== "" &&
                                    <option disabled>
                                        Choose province
                    ...
                    {/* Input Village */}
                    <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-2">
                        <label className="block text-gray-800  col-span-4 sm:col-span-2 font-medium text-sm">
                            No.
                        </label>
                        <div className="col-span-8 sm:col-span-4">
