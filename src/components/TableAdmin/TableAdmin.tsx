...
interface ITableAdmin {
    ...
    getAllBranch?: (pageActive: number) => Promise<void>,
    getAllMarketing?: (pageActive: number) => Promise<void>
}
...
function TableAdmin(props: ITableAdmin) {
    ...
    useEffect(() => {
        ...
        props?.getAllBranch && props?.getAllBranch(pageActive)
        props?.getAllMarketing && props?.getAllMarketing(pageActive)
    }, [pageActive]);
