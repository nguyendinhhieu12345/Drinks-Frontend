...
interface IFilterProduct {
    ...
    handleSeachProduct: () => Promise<void>,
    handleResetProduct: () => Promise<void>
}

function FilterProduct({ setSearch, setCategoryId, category, setStatus, handleResetProduct, handleSeachProduct }: IFilterProduct) {
    return (
