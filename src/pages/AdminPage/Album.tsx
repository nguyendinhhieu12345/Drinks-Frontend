...
import FilterAlbums from "@/components/Album/FilterAlbums";
import MenuAddFile from "@/components/Album/MenuAllFile";
...
function Album() {
    ...
    return (
        <div className="mx-5">
            {/* add image */}
            <MenuAddFile handleOpen={handleOpen} />

            <FilterAlbums setFilters={setFilters} handleFilter={handleFilter} handleResetFilter={handleResetFilter} />
